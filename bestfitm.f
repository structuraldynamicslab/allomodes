...
c===================================================================================
c
C	bestfitm.f		Version 1 19/5/1993	Patrice Koehl
c
c	This subroutine performs the mass-weighted best fit of two structures
...
c===================================================================================
c
	subroutine bestfitm(coord1,nat1,coord2,nat2,nat,list1,list2,
     1			rmsd,ierr,amass1,amass2)
c
c===================================================================================
c===================================================================================
c
	integer	i,j,k,nat,job,info,ierr,nat1,nat2
	integer	list1(nat),list2(nat)
c
	real*8	deter,tiny
	real*8	rmsd,sign,det,norm
	real*8	xmass1,xmass2
	real*8	a(3,3),u(3,3),v(3,3),r(3,3),d(3),work(3),work2(3)
...
c
	...
	do 300 i = 1,nat
	    do 200 j = 1,3
		xc1(j) = xc1(j) + coord1(j,list1(i))*amass1(list1(i))
		xc2(j) = xc2(j) + coord2(j,list2(i))*amass2(list2(i))
200	    continue
	    xmass1 = xmass1 + amass1(list1(i))
	    xmass2 = xmass2 + amass2(list2(i))
300	continue
c
	do 400 i = 1,3
		xc1(i) = xc1(i)/xmass1
...
c
	job = 11
	call dsvdc(a,3,3,3,d,work,u,3,v,3,work2,job,info)
c
	if(info.ne.0) then
...
c
c===================================================================================
c	Apply rotation on molecule 2 and store results in coord2 :
c===================================================================================
c
	do 1900 i = 1,nat2
		do 1700 j = 1,3
